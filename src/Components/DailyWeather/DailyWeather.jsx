      ...
      {daily.time.map((timestamp, i) => {
        ...
        return (
          ...
          >
            ...
            <div className="temps">
              <p><span>{t.max}:</span> {degree==="Цельсий"?daily.temperature_2m_max[i]+"°": daily.temperature_2m_max[baseIndex - 3 + i] * 2 + 30 + "F"}</p>
              <p><span>{t.min}:</span> {degree==="Цельсий"?daily.temperature_2m_min[i]+"°": daily.temperature_2m_min[baseIndex - 3 + i] * 2 + 30 + "F"}</p>
            </div>
          </div>
